...
//
//
// $Id: G01PhysicsList.cc 70911 2013-06-07 11:05:37Z mverderi $
//
// 
...
G01PhysicsList::G01PhysicsList():  G4VUserPhysicsList()
{
  SetVerboseLevel(1);
}
...
void G01PhysicsList::ConstructBosons()
{
  // pseudo-particles
...
void G01PhysicsList::ConstructLeptons()
{
...
void G01PhysicsList::ConstructMesons()
{
...
void G01PhysicsList::ConstructBaryons()
{
...
void G01PhysicsList::ConstructIons()
{
...
void G01PhysicsList::AddTransportation()
{
...
void G01PhysicsList::ConstructEM()
{
...
#include "G4Decay.hh"
void G01PhysicsList::ConstructGeneral()
{
  // Add Decay Process
...
void G01PhysicsList::AddParameterisation()
{
