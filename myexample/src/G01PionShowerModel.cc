...
//
//
// $Id: G01PionShowerModel.cc 66241 2012-12-13 18:34:42Z gunter $
//
#include "G01PionShowerModel.hh"
...
G01PionShowerModel::G01PionShowerModel(G4String modelName, G4Region* envelope)
...
G01PionShowerModel::G01PionShowerModel(G4String modelName)
...
G01PionShowerModel::~G01PionShowerModel()
{
  delete fFakeStep;
  delete fpNavigator;
}

G4bool G01PionShowerModel::IsApplicable(const G4ParticleDefinition& particleType)
{
  return 
...
G4bool G01PionShowerModel::ModelTrigger(const G4FastTrack&)
{
...
void G01PionShowerModel::DoIt(const G4FastTrack& fastTrack, 
                     G4FastStep& fastStep)
{
  //  G4cout << "G01PionShowerModel::DoIt" << G4endl;
...
void G01PionShowerModel::Explode(const G4FastTrack& fastTrack)
{
  //-----------------------------------------------------
...
void G01PionShowerModel::BuildDetectorResponse()
{
...
void G01PionShowerModel::AssignSpotAndCallHit(const G01EnergySpot &eSpot)
{
  //
  // "converts" the energy spot into the fake
  // G4Step to pass to sensitive detector:
...
void G01PionShowerModel::FillFakeStep(const G01EnergySpot &eSpot)
{
  //-----------------------------------------------------------
