...
// ********************************************************************
//
// $Id: G01ParallelWorldForPion.cc 77659 2013-11-27 08:57:46Z gcosmo $
//
#include "G01ParallelWorldForPion.hh"
...
G01ParallelWorldForPion::G01ParallelWorldForPion(G4String worldName)
  : G4VUserParallelWorld(worldName)
{;}

G01ParallelWorldForPion::~G01ParallelWorldForPion()
{;}

void G01ParallelWorldForPion::Construct()
{
...
void G01ParallelWorldForPion::ConstructSD()
{
  ...
  new G01PionShowerModel("ghostPionShowerModel",ghostRegion);
